        ...
        <ul class="nav navbar-nav">
                                ...
                                <div class="media media-sm p-4 mb-0">
                                    ...
                                    <div class="media-body">
                                        <a href="user-profile.html">
                                            ...
                                            <span class="discribe">On disposal of as landlord Afraid at highly months
                                                do things on
                                                at.</span>
                                            <span class="time">
                                                <time>1 hrs ago</time>...
            ...
            <li class="dropdown">
                <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                    <img src="{{ asset('images/' . $locale . '-flag.png') }}" height="20" />
                    <span class="d-none d-lg-inline-block">{{ __('sidebar.' . $locale) }}</span>
                </button>
                <ul class="dropdown-menu" style="width: 30%;">
                    @foreach (all_local() as $item)
                        <li class="p-2">
                            <a href="{{ route('change-lang', ['locale' => $item]) }}">
                                <img src="{{ asset('images/' . $item . '-flag.png') }}" height="20" />
                                <span class="d-none d-lg-inline-block">{{ __('sidebar.' . $item) }}</span>
                            </a>
                        </li>
                    @endforeach
                </ul>
